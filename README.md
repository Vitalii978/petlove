...
✅ Аутентификация пользователей ✅ Валидация форм с react-hook-form & yup ✅
Фильтрация и сортировка объявлений ✅ Функциональность избранного ✅ История
просмотров ✅ Добавление питомцев ✅ Адаптивный дизайн (от 320px до 1280px) ✅
Пагинация с номерами страниц ✅ Модальные окна с правильными обработчиками
закрытия ✅ Обработка ошибок и обратная связь пользователю ✅ Качество кода и
форматирование ✅ Семантическая верстка (ul/li где нужно) ✅ Оптимизация
изображений ✅ Поддержка ретина-экранов
...
GitHub: VitaliiKlymenko

Email: socolikvol@gmail.com
