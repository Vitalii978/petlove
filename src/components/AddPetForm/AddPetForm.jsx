...
const AddPetSchema = Yup.object().shape({
  ...
  species: Yup.string()
    .required('Pet type is required'), // Обязательное поле
...
const AddPetForm = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      ...
      alert(`🎉 Pet "${response.data.name || values.name}" added successfully!`);
  ...
  return (
    <>
      ...
      <h1 className={styles.title}>
        Add my pet /
        <span className={styles.spanTitle}> Personal details</span>
      </h1>
