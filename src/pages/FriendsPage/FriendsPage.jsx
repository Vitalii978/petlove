...
const fetchFriends = useCallback(async () => {
  try {
    ...
    console.log('📊 Результат friendsApi.getFriends:', {
      ...
      количествоДанных: Array.isArray(result.data) ? result.data.length : 'не массив',
    ...
    <section className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.description}>
          <p>
            Meet our wonderful partners who help us find homes for pets 
          ...
          <>
            ...
            <div className={styles.info}>
              <p className={styles.count}>
                We cooperate with <strong>{friends.length}</strong> organizations
              </p>
            </div>
